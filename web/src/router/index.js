...
const routes = [
  ...
  },
  {
    ...
    component: () => import('../views/student/StudentSubmit.vue'),
    meta: { role: 'student' },
  },
]
...
router.beforeEach((to) => {
  ...
  if (user.must_change_password && to.path !== '/password')
    return { path: '/password', query: { redirect: to.fullPath } }
  if (to.meta.role && to.meta.role !== user.role)
    return user.role === 'teacher' ? '/teacher/courses' : '/student/courses'
})
