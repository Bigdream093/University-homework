  ...
  const totalRaw =
    dailyRaw !== null && finalRaw !== null
      ...
      : dailyRaw !== null
        ...
        : finalRaw
  return {
    daily_score: dailyRaw === null ? null : round1(dailyRaw),
    final_score: finalRaw === null ? null : round1(finalRaw),
    // 期末未指定或未评分时总成绩暂按平时成绩展示，界面与导出说明中注明。
    total_score: totalRaw === null ? null : round1(totalRaw),
  }
}
