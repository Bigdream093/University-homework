export function errorHandler(err, _req, res, _next) {
  const multerMessages={LIMIT_PART_COUNT:'上传内容部分过多',LIMIT_FILE_SIZE:'上传文件超过大小限制',LIMIT_FILE_COUNT:'上传文件数量过多',LIMIT_FIELD_KEY:'上传字段名称过长',LIMIT_FIELD_VALUE:'上传字段内容过长',LIMIT_FIELD_COUNT:'上传字段数量过多',LIMIT_UNEXPECTED_FILE:'上传文件字段无效'};
